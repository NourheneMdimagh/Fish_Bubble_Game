...
// Bubbles
const bubblesArray = [];
const bubblesPop = new Image();
bubblesPop.src = 'buble_pop_two_01.png';
class Bubble {
    constructor (){
    ...
    draw(){
        ...
        ctx.stroke();
        ctx.save();
        ctx.drawImage(bubblesPop, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight, this.x - 60, this.y - 45, this.spriteWidth/4, this.spriteHeight/4);
    }
}
